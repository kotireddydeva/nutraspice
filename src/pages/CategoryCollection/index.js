...
const CategoryCollection = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      const allProducts = [
        ...
        { id: 2, name: "Product 2", price: 799, image: "https://placehold.co/300x200/F7D0B3/422402?text=Product", category: "almond" },
  ...
  return (
    <div className="max-w-[90%] mx-auto py-8">
      <h2 className="text-3xl font-bold mb-6 text-center">{category.charAt(0).toUpperCase() + category.slice(1)} Collection</h2>
